    ...
    return ( 
        <nav className="fix_topscroll logo_on_fixed topbar navigation">
            <div className="nav-wrapper container">
                ...
                <a href="#" data-target="" className="waves-effect waves-circle navicon back-button htmlmode show-on-large"><i class="mdi mdi-chevron-left" data-page=""></i></a>
                ...
                <a href="#" data-target="" class="waves-effect waves-circle navicon right nav-site-mode show-on-large"><i className="app-icon-brightness-contrast"></i></a>
            </div>
        </nav>
    );
}
